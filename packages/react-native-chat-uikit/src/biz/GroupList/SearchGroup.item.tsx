...
export type SearchGroupItemProps = ListItemProps &
  ListItemRequestProps<DataModel> & {};
export function SearchGroupItem(props: SearchGroupItemProps) {
  const {} = props;
  return (
    <View
      style={{
...
export const SearchGroupItemMemo = React.memo(SearchGroupItem);
