...
export type SearchGroupParticipantItemProps = ListItemProps &
  ListItemRequestProps<DataModel> & {};
export function SearchGroupParticipantItem(
  props: SearchGroupParticipantItemProps
) {
  const {} = props;
  return (
    <View
...
export const SearchGroupParticipantItemMemo = React.memo(
  SearchGroupParticipantItem
);
