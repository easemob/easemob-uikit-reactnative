...
export class ImageViewer extends React.Component<
  ...
  ImageViewerState
> {
  public static defaultProps = new ImageViewerProps();
  public state = new ImageViewerState();
  ...
  static getDerivedStateFromProps(
    nextProps: ImageViewerProps,
    prevState: ImageViewerState
  ) {
  ...
  public componentDidUpdate(
    prevProps: ImageViewerProps,
    _prevState: ImageViewerState
  ) {
   ...
   * props 有变化时执行
   */
  public init(nextProps: ImageViewerProps) {
    if (nextProps.imageUrls.length === 0) {
      // 隐藏时候清空
      this.fadeAnim.setValue(0);
      return this.setState(new ImageViewerState());
    }
